...
LEARNING_UNITS = {
    "opening-mishnah": {
        ...
        "summary": "החטיבה עוסקת במפת אבות הנזיקין ובהבדלים ובמשותף שביניהם.",
    ...
    "av-toldah": {
        "title": "אב ותולדה",
        "summary": "החטיבה עוסקת ביחס שבין אב לתולדה ובשאלה אם דיניהם זהים.",
    ...
    "keren": {
        "title": "משפחת קרן",
        "summary": "החטיבה עוסקת בקרן, במאפייניה, בתולדותיה ובדינים הנובעים מהם.",
    ...
    "shen-regel": {
        "title": "משפחת שן ורגל",
        "summary": "החטיבה עוסקת בשן וברגל, במאפייניהן, בתולדותיהן ובדינים הנובעים מהם.",
        "icon": """<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M3.5 4.5c-1.2 1-1.7 2.5-1.4 4.3.4 3 1.5 5.8 3.2 8.2.7-1.3 1.2-2.8 1.5-4.5.3 1.7.8 3.2 1.5 4.5 1.7-2.4 2.8-5.2 3.2-8.2.3-1.8-.2-3.3-1.4-4.3-1.6 1.1-5.8 1.1-7.5 0Z"/><path d="M16.5 4.5v8.2c0 1.4-.7 2.5-1.8 3.2l-1.2.8"/><path d="M20.5 4.5v8.2c0 1.4.7 2.5 1.8 3.2"/><path d="M14.4 17.2h7.2c.5 0 .9.4.9.9 0 1.1-.9 1.9-1.9 1.9h-5.2c-1 0-1.9-.8-1.9-1.9 0-.5.4-.9.9-.9Z"/></svg>""",
    },
    "bor": {
        "title": "משפחת בור",
        "summary": "החטיבה עוסקת בבור, במאפייניו, בתולדותיו ובדינים הנובעים מהם.",
        "icon": """<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M2.5 8.5h4M17.5 8.5h4"/><ellipse cx="12" cy="10" rx="5.5" ry="2.5"/><path d="M6.5 10v4.5c0 2.7 2.5 4.9 5.5 4.9s5.5-2.2 5.5-4.9V10"/><path d="M8.5 11.2c1 .7 2.2 1 3.5 1s2.5-.3 3.5-1"/></svg>""",
    },
    "maveh": {
        "title": "משפחת מבעה",
        "summary": "החטיבה עוסקת בזהותו של מבעה, במאפייניו ובתולדותיו.",
        "icon": """<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><circle cx="6" cy="5" r="1.8"/><path d="M6 7v6M3.5 10h5M6 13l-2 6M6 13l2 6"/><path d="M15 4c-1.8 1-2.7 2.7-2.7 5.1 0 4.2 1.7 7.8 4.2 10.4.8-1.7 1.5-3.5 1.5-5.8 0 2.3.7 4.1 1.5 5.8 2.5-2.6 4.2-6.2 4.2-10.4C23.7 6.7 22.8 5 21 4c-1.7 1.5-4.3 1.5-6 0z"/></svg>""",
    },
    "esh": {
        "title": "משפחת אש",
        "summary": "החטיבה עוסקת באש, במאפייניה, בתולדותיה ובדינים הנובעים מהם.",
        "icon": """<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12.2 21c-4.1-1.1-6.4-4-6.4-7.5 0-2.8 1.5-5.5 4.6-8.5.1 2.3.9 3.8 2 5.1.5-3.5 2.1-6.2 4.8-8.1.2 3.4 2.8 5.5 2.8 9.8 0 4.1-2.8 7.6-7.8 9.2Z"/><path d="M12.1 20c-1.8-.8-2.8-2.2-2.8-3.9 0-1.5.8-3 2.4-4.5.1 1.2.5 2 1.2 2.7.2-1.8 1-3.2 2.3-4.2.1 1.8 1.5 2.8 1.5 5.1 0 2.2-1.5 4.1-4.6 4.8Z"/></svg>""",
    },
}
