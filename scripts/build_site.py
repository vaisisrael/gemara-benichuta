...
LEARNING_UNITS = {
    ...
    "maveh": {
        "title": "משפחת מבעה",
        "summary": "הגמרא חוזרת אל מבעה: לשמואל הוא שן ולרב הוא אדם, ובודקת אילו נזקים יכולים להיחשב תולדות שלו.",
    ...
    "esh": {
        "title": "משפחת אש",
        "summary": "הגמרא עוברת לאש, בוחנת נזקים שכוח אחר משתתף בהולכתם, ומבררת אם תולדות אש דינן כאש.",
        "icon": """<svg viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M10.5 20c-3.2-1.4-4.8-3.8-4.8-6.6 0-2.5 1.3-4.7 3.8-7.2.1 2 .8 3.1 1.8 4.1.3-3.2 1.8-5.6 4.1-7.3.2 3 2.7 4.6 2.7 8.5 0 3.8-2 6.8-5.6 8.5"/><path d="M2.5 7h4M1.5 10h5M17.5 6h4"/></svg>""",
    },
}
